      ...
      blocks: [
        {
          ...
          bullets: {
            items: [
              ...
              "We learned how they think about long stays: everything above 30 nights is considered to be a long reservation.",
      ...
      blocks: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "PMCs were left to collect money outside the system — via bank transfer, cash, or third-party tools — creating reconciliation problems, audit gaps, and lost processing revenue for Guesty.",
          ],
        },
        {
          heading: "My role",
      ...
      blocks: [
        {
          ...
          visual: {
            src: "/images/payment-links/2026-08-25/solution-1.jpg",
        ...
        },
        {
          ...
          visual: {
            src: "/images/payment-links/2026-08-25/solution-2.jpg",
      ...
      blocks: [
        {
          ...
          visual: {
            src: "/images/find-inspiration/2026-08-25-v2/context.jpg",
        ...
        },
        {
          ...
          visual: {
            src: "/images/find-inspiration/2026-08-25-v2/scope.jpg",
        ...
        },
        {
          ...
          visual: {
            src: "/images/find-inspiration/2026-08-25-v2/references.jpg",
